...
export function AdminSidebar() {
  ...
  return (
    ...
    >
      <Link href="/admin/orders" className="mb-12 block focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gold/50 focus-visible:ring-offset-2 focus-visible:ring-offset-admin-sidebar-bg rounded-sm">
